...
class PopularViewPagerAdapter(val list: ArrayList<Products>, val method: SearchPembeliActivity): RecyclerView.Adapter<PopularViewPagerAdapter.DaftarViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DaftarViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_viewpager_popular, parent, false)
