...
class RatingProdukPenjualAdapter(private var list: ArrayList<ReviewProduct>): RecyclerView.Adapter<RatingProdukPenjualAdapter.DaftarRatingViewHolder>() {
    ...
    inner class DaftarRatingViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DaftarRatingViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_daftar_rating, parent, false)
        return DaftarRatingViewHolder(view)
    }

    override fun onBindViewHolder(holder: DaftarRatingViewHolder, position: Int) {
