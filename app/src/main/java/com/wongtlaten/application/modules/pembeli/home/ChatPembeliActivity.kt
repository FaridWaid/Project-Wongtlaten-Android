...
import com.wongtlaten.application.modules.penjual.chatting.ChatPenjualActivity
import com.wongtlaten.application.modules.penjual.chatting.ChatPenjualAdapter
import de.hdodenhof.circleimageview.CircleImageView

class ChatPembeliActivity : AppCompatActivity() {
    ...
    private lateinit var idUsers: FirebaseUser
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("dataAkunUser").child(idPenjual)
        reference = FirebaseDatabase.getInstance().getReference("dataChatting").child(idUsers.uid)
        ...
        btnSendMessage.setOnClickListener {
            ...
            if (message.isEmpty()){
                ...
                sendMessage(idChats, idUsers.uid, idPenjual, message)
                etMessage.setText("")
            }
        }

        updateMessage(idPenjual, idUsers.uid)
        readMessage(idUsers.uid, idPenjual)
    ...
    fun readMessage(senderId: String, receiverId: String) {
        val databaseReferenceChat: DatabaseReference =
            FirebaseDatabase.getInstance().getReference("dataChatting").child(idUsers.uid)
        ...
        alertDialog.apply {
            ...
            setPositiveButton(
                ...
                DialogInterface.OnClickListener { dialogInterface, i ->
                    ...
                    if (!isConnected(this@ChatPembeliActivity)){
                        showInternetDialog()
                    }
                })
        }
    ...
    private fun isConnected(contextActivity: ChatPembeliActivity): Boolean {
