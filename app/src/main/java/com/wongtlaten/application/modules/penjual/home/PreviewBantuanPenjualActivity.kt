...
class PreviewBantuanPenjualActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_preview_bantuan_penjual)
        ...
        alertDialog.apply {
            ...
            setPositiveButton(
                ...
                DialogInterface.OnClickListener { dialogInterface, i ->
                    ...
                    if (!isConnected(this@PreviewBantuanPenjualActivity)){
                        showInternetDialog()
                    }
                })
        }
    ...
    private fun isConnected(contextActivity: PreviewBantuanPenjualActivity): Boolean {
