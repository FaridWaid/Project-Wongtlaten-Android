...
import com.wongtlaten.application.modules.pembeli.wishlist.DetailPesananPembeliAdapter
import java.text.DecimalFormat
import java.text.NumberFormat

class DetailPesananPenjualAdapter(val list: ArrayList<Transaction>): RecyclerView.Adapter<DetailPesananPenjualAdapter.DaftarViewHolder>() {
