...
class PiguraPembeliActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pigura_pembeli)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()){
                    ...
                    for (i in snapshot.children){
                        ...
                        if (products.kategoriProduct == "pigura" && products.statusProduct != "deleted"){
        ...
        alertDialog.apply {
            ...
            setPositiveButton(
                ...
                DialogInterface.OnClickListener { dialogInterface, i ->
                    ...
                    if (!isConnected(this@PiguraPembeliActivity)){
                        showInternetDialog()
                    }
                })
        }
    ...
    private fun isConnected(contextActivity: PiguraPembeliActivity): Boolean {
