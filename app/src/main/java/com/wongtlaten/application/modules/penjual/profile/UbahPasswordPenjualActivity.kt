...
class UbahPasswordPenjualActivity : AppCompatActivity() {
    ...
    // Membuat fungsi "passwordLamaFocusListener"
    private fun passwordLamaFocusListener() {
        // Memastikan apakah etPasswordLama sudah sesuai dengan format pengisian
    ...
    // Membuat fungsi "passwordBaruFocusListener"
    private fun passwordBaruFocusListener() {
        // Memastikan apakah etPasswordBaru sudah sesuai dengan format pengisian
    ...
    private fun validPassword(passwordInput: String): String? {
        ...
        // Jika password kosong maka akan gagal dan muncul error harus isi terlebih dahulu
        if (password.isEmpty()){
            return "Password Harus Diisi!"
        }
        // Jika panjang password kurang dari 6 maka akan gagal
    ...
    private fun showInternetDialog() {
        ...
        alertDialog.apply {
            ...
            setPositiveButton(
                ...
                DialogInterface.OnClickListener { dialogInterface, i ->
                    dialogInterface.dismiss()
                    if (!isConnected(this@UbahPasswordPenjualActivity)){
                        showInternetDialog()
                    }
                })
        }
    ...
    private fun isConnected(contextActivity: UbahPasswordPenjualActivity): Boolean {
