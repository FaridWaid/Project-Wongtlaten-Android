...
class GiftboxPembeliActivity : AppCompatActivity() {

    private lateinit var rvDaftarProduk: RecyclerView
    private lateinit var daftarProdukList: ArrayList<Products>
    private lateinit var adapterCategory: DaftarCategoryProductAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_giftbox_pembeli)
        ...
        adapterCategory = DaftarCategoryProductAdapter(daftarProdukList)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()){
                    ...
                    for (i in snapshot.children){
                        ...
                        if (products.kategoriProduct == "giftbox" && products.statusProduct != "deleted"){
                            daftarProdukList.add(products)
                        }
                    }

                    adapterCategory = DaftarCategoryProductAdapter(daftarProdukList)
                    rvDaftarProduk.adapter = adapterCategory
                }
            }
        ...
        alertDialog.apply {
            ...
            setPositiveButton(
                ...
                DialogInterface.OnClickListener { dialogInterface, i ->
                    ...
                    if (!isConnected(this@GiftboxPembeliActivity)){
                        showInternetDialog()
                    }
                })
        }
    ...
    private fun isConnected(contextActivity: GiftboxPembeliActivity): Boolean {
