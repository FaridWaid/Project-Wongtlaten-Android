...
class BouquetPembeliActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_bouquet_pembeli)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()){
                    ...
                    for (i in snapshot.children){
                        ...
                        if (products.kategoriProduct == "bouquet" && products.statusProduct != "deleted"){
        ...
        alertDialog.apply {
            ...
            setPositiveButton(
                ...
                DialogInterface.OnClickListener { dialogInterface, i ->
                    ...
                    if (!isConnected(this@BouquetPembeliActivity)){
                        showInternetDialog()
                    }
                })
        }
    ...
    private fun isConnected(contextActivity: BouquetPembeliActivity): Boolean {
